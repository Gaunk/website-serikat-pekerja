...
<div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
    <div class="card">
        <h5 class="card-header">Edit Clients</h5>
        <div class="card-body">
            <form action="<?= base_url('admin/edit_clients/' . $clients['id']) ?>" method="POST" enctype="multipart/form-data" id="basicform">
    ...
    <div class="form-group">
        ...
        <input 
            ...
            id="image_name" 
            name="image_name" 
            value="<?= set_value('image_name', $clients['image_name']) ?>" 
            required 
            class="form-control" 
