...
<div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin/edit_slides/' . $slides->id) ?>" method="POST" enctype="multipart/form-data" id="basicform">
    ...
    <div class="form-group">
        ...
        <input 
            ...
            id="judul" 
            name="judul" 
            value="<?= set_value('judul', $slides->judul) ?>" 
            required 
            class="form-control" 
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="status" name="status" required>
                ...
                <?php foreach ($status_options as $key => $label): ?>
                    <option value="<?= $key ?>" <?= ($slides->status == $key) ? 'selected' : '' ?>>
                        <?= $label ?>
                    </option>
                <?php endforeach; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <textarea 
            ...
            rows="5" 
            required
        ><?= set_value('deskripsi', $slides->deskripsi) ?></textarea>
    </div>
    ...
    <div class="form-group text-right">
        <a href="<?= base_url('admin/slides') ?>" class="btn btn-secondary">Kembali</a>
