        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              <img src="<?= base_url($logo->image) ?>" alt="">
              <div class="hero-btns">
                <a href="#contact" class="btn" style="background-color: #0097b2; border-color: #0097b2; color: white;">
              ...
              <div class="hero-stats">
                ...
                <div class="stat-item">
                  <h3><span data-purecounter-start="0" data-purecounter-end="1260" data-purecounter-duration="1" class="purecounter"></span>+</h3>
                  <p>Serikat Pekerja</p>
                </div>
                <div class="stat-item">
                  <h3><span data-purecounter-start="0" data-purecounter-end="100" data-purecounter-duration="1" class="purecounter"></span>%</h3>
                  <p>Melindungi Pekerja</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div >
            <p style="font-size: 18px; /* ukuran ideal untuk deskripsi */
              font-family: 'Poppins', sans-serif; /* modern, bersih, populer */
              font-weight: 400;
              line-height: 1.6;
              color:rgb(41, 6, 6); /* atau #333 untuk background terang */
              text-shadow: none;"><?= isset($profile['site_desc']) ? $profile['site_desc'] : '' ?>.</p>
          </div>
