...
<script>
    // Function to update the filename when a file is selected
    function updateFileName() {
        ...
        // Display the file name below the input
    ...
    reader.onload = function(event) {
        ...
        imgElement.src = event.target.result; // Set image source to the file data
